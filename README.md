...
3)**Вставка файлів**:Коли ви натисніть кнопку зберегти файли на вашому мікроконтролері , але обов'язково зберіжіть файли під тією назвою що і на гіт хабі.Це дозволить запускати код без вашої допомоги .
