...
1)**Автономність:** Схема працює від блоку живлення , але можна зробити щоб працювала від батарейок, тому навіть при відключенні електроенергії вона продовжить функціонувати. Це особливо важливо в регіонах з частими перебоями в електропостачанні.Єдине що вама може завадити це відсутність вай фаю ,але є рішення або запустити схему без використанння його, або приобрести вай-фай який працює у відключення свтла.
